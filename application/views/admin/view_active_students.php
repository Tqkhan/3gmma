                                            ...
                                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                                ...
                                                <?php foreach ($students as $student): ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="<?php echo base_url() ?>admin/edit_student/<?php echo $student['studentID'] ?>"><i class="fa fa-edit fa-2x"></i></a> <a href="<?php echo base_url() ?>admin/student_deactivate/<?php echo $student['studentID'] ?>"><i class="fa fa-power-off fa-2x" aria-hidden="true"></i></a></td>
