...
<form action="<?php echo base_url() ?>admin/edit_profile/<?php echo $users['adminID'] ?>" method="post">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">User Name</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $users['user_name'] ?>" name="user_name" placeholder="User Name" type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $users['email'] ?>" name="email" placeholder="Expense Amount " type="email" required="required" id="example-text-input">
                                            </div>
                                        </div>
...
<div class="col-sm-9">
<input class="form-control" value="<?php echo $users['password'] ?>" name="password" placeholder="Expense Amount" type="text" required="" id="example-text-input">
</div>
</div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $users['role'] ?>" name="role" placeholder="Expense Amount " type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
...
<select class="form-control select coursedataID" name="is_active"  type="text" id="clearclass1" required="">
<option value="1" <?php  if($users['is_active'] == '1'){echo 'selected';} ?>>active</option>
<option value="0" <?php  if($users['is_active'] == '0'){echo 'selected';} ?>>In_active</option>
                                        ...
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Created at</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $users['created_at'] ?>" name="created_at" placeholder="Expense Amount " type="date" required="" id="example-text-input" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input class="form-control" name="submission_date" placeholder="Update Date" type="hidden" required="" id="example-text-input" value="<?php echo  date("Y/m/d"); ?>">


<input type="hidden" name="campus_id" value="<?php echo $users['campus_id']; ?>">
<input type="hidden" name="adminID" value="<?php echo $users['adminID']; ?>">
