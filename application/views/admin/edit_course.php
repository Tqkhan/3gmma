                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Course Fee </label>
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $course['course_price'] ?>" name="course_price" required="" placeholder="Price  " type="number" id="example-text-input">
                                            </div>
                                        </div>
