                            ...
                            <div class="col-sm-12">
                                ...
                                <hr>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="dob" placeholder="Date of Birth" type="text" required="" id="bday">
                                            </div>
                                        </div>
                           ...
                           <label for="example-text-input" class="col-sm-2 col-form-label">Gender<span class="required">*</span></label>
                                  ...
                                  <span> Female </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control cnic" name="student_cnic" placeholder="Student CNIC" type="text" required="" id="" >
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Education</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="education" placeholder="Student Education" type="text" required="" id="" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="home_phone" placeholder="Whatsapp number" type="text" required="" id="example-text-input" >
                                            </div>
                                        </div>
                              ...
                              <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                               <select class="form-control select shift newt" name="course_shift"  required="" type="text" id="example-text-input">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control select coursedataID" name="courseID[]"  type="text" id="courseID" required="">
                        ...
                        <hr>
                         <div class="panel-heading">
                                    ...
                                    <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Name</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="emergency_name" placeholder="Emergency person Name " type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Home Phone</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="emergency_home" placeholder="Emergency person Phone" type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Relationship</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="emergency_relation" placeholder="Emergency person in relation" type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Cell no</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="emergency_mobile" placeholder="Emergency person cell number" type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
                    <hr>
                         <div class="panel-heading">
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="father_name" placeholder="Enter Guardian name" type="text" required="" id="example-text-input">
                                            </div>
                                        </div>
                      <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">Mobile number</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="father_mobile" placeholder="Enter Guardian number" type="text" required="" id="example-text-input" >
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-3 col-form-label">C.N.I.C</label>
                                            <div class="col-sm-9">
                                                <input class="form-control cnic" name="father_cnic" placeholder="" type="text" required="" id="">
                                            </div>
                                        </div>
