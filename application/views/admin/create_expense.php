                                ...
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="submission_date" placeholder="Submission Date" type="date" required="" id="example-text-input">
                                            </div>
                                        </div>

                                        <div class="form-group row col-md-12">
                                           <input type="submit" value="Create Expense" class="btn btn-primary pull-right">
                                        </div>
